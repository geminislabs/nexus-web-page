				...
				<svg class="icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<g id="SVGRepo_iconCarrier">
						<path
							...
							fill="currentColor"
						></path>
						<path d="M5 6H15.5752" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
						></path>
						<path d="M5 11H10.2374" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
						></path>
						<path d="M5 16H7.24461" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
						></path>
						<circle cx="17.5" cy="17.5" r="5.5" stroke="currentColor" stroke-width="1.5"></circle>
						<path
