...
class ApiService {
	...
	// ============================================
	// MÉTODOS DE GEOCERCAS (SISCOM-ADMIN-API)
	// ============================================
	 ...
	 * @param {Object} data - Datos de la geocerca
	...
	// ============================================
	// MÉTODOS DE REGLAS DE ALERTA (SISCOM-ADMIN-API)
	// ============================================

	/**
	 * Listar todas las reglas de alerta
	 * GET /api/v1/alert_rules
	 * @returns {Promise<Array>} Lista de reglas de alerta
	 */
	async getAlertRules() {
	 ...
	 * @returns {Promise<Object>} Regla de alerta
	 */
	...
	// ============================================
	// HISTORIAL DE ALERTAS (SISCOM-ADMIN-API)
	// ============================================

	/**
	 * Listar historial de alertas generadas
	 * GET /api/v1/alerts
